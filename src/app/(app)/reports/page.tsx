  ...
  return (
    <div className="p-8">
      ...
      <p className="mb-4 text-xs text-slate-400">
        คอลัมน์: ลำดับที่ · ชื่อลูกค้า · ประเภทประกัน · บริษัทประกัน · ทะเบียน/รุ่นรถ (เฉพาะประกันรถ) · วันแจ้งงาน ·
        วันคุ้มครอง · วันหมดอายุ · เบี้ยสุทธิ · อากรแสตมป์ · ภาษี (VAT) · เบี้ยรวม · วันชำระเงิน —{" "}
        <span className="font-medium">ไม่มีเบอร์โทร</span>
      </p>
